...
- (void) rechargeViaInAppPurchaseWithAmount:(NSNumber *) aAmount andReceipt:(NSString *) aReceipt {
	...
	[transport3.config setUserName:@"gabo_ba" ];
	[transport3.config setPassWord:@"2e39abad0f271bc8dc27917e142be998"];
...
- (NSString *) rechargeViaInAppDemoWithAmount:(NSString *) aAmount {
	...
	[model setCurrentRechargeAmount:aAmount];
	[model setFirstName:@"In"];
	[model setLastName:@"App"]; 
	[model setEmail:@"inapp@inapp.com"]; 
	[model setPhone:@""];  
	[model setStreet:@""]; 
	[model setCity:@""]; 
	[model setState:@""]; 
	[model setZipcode:@""]; 
	[model setCurrentCardCountryCode:@""]; 
	[model setCurrentCardNum:@"99995423"]; 
	[model setCurrentCardMonth:@""]; 
	[model setCurrentCardYear:@""]; 
	[model setCurrentCardType:@""]; 
	...
	if ([transport3.config.errorCode isEqualToString:@"none"]) {
		cardHistoryID = [gatewayInterface rechargeAccountViaCC:sandboxGatewayID 
													withSerial:[NSNumber numberWithLong:[[model serialNumber] longLongValue]] 
													   andLoad:[NSNumber numberWithFloat:[aAmount floatValue]] 
												   anFirstName:[model firstName] 
												   andLastName:[model lastName] 
													  andEmail:[model email] 
													  andPhone:[model phone]  
